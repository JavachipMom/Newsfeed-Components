...
//Structuring the javascript like HTML by creating my elements
...
function articleCreator(title, date, firstp, secondp, thirdp) {
  ...
  articleParagraph1.textContent = firstp;
  articleParagraph2.textContent = secondp;
  articleParagraph3.textContent = thirdp;
